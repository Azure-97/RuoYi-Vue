...
<script>
import {addLeave, delLeave, exportLeave, getLeave, listLeave, updateLeave} from '@/api/workflow/leave'
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('/workflow/leave/export', { ...this.queryParams}, `post_${new Date().getTime()}.xlsx`)
    },
    chooseMedicine() {
